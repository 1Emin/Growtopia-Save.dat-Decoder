...
namespace GrowtopiaHack
{
    public partial class Form1 : MetroSuite.MetroForm
    {
        ...
        {
            InitializeComponent();
            pathsave.Text = "C:\\Users\\" + Environment.UserName + "\\Appdata\\Local\\Growtopia";
            metroLabel2.Text = "C:\\Users\\" + Environment.UserName + "\\Desktop";
            System.Diagnostics.Process.Start("https://dsc.gg/sahyui");
        }
        ...
        private void metroButton5_Click(object sender, EventArgs e)
        {
            ...
            TextWriter tw = new StreamWriter(metroLabel2.Text + "\\Account.txt");
            // write a line of text to the file
            tw.WriteLine(richTextBox1.Text);
            // close the stream
            tw.Close();
            MessageBox.Show("Saved to " + metroLabel2.Text + "\\Account.txt", "Saved Account Informations", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
